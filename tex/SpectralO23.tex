...
\begin{document}
  ...
  \begin{abstract}
    ...
    central character.
    It selects an admissible carrier in all seventeen dicyclic levels examined, and one step of
    its justification remains unproved.
    The residual obstruction on this bridge is therefore a single missing proof step inside a
    specific candidate rule, not the non-existence of a two-dimensional module and not an
  ...
  \subsection{What the O12 filtration supplies on Bridge 1, and what it does not}
    ...
    \begin{remark}[The exclusion does not extend to dicyclic groups]
      ...
      They therefore embed in a Borel subgroup, and they carry faithful irreducible complex
    ...
    \begin{remark}[Scope of the obstruction]
      ...
      the three levels with deposited decompositions and a further fourteen dicyclic levels at
      $q = 53$ and $q = 101$, hence $17$ of $17$.
      ...
      examined.
      Promoting it to a selector requires proving the observed step; that is a well-posed open
      problem, and it is the natural continuation of this work.
  ...
  $\{c_{\Sigma}, q - c_{\Sigma}\}$ --- succeeds on every level examined
  (Corollary~\ref{cor:selection-not-existence}, Remark~\ref{rem:o12-scope}).
  The residual obstruction on this bridge is thus one open proof step, not an existence
  problem.
  ...
  \paragraph{Interpretive outlook (interpretation, not a result).}
    ...
    much smaller than before: one proof step inside an identified candidate rule, rather than a
    construction of the carrier from nothing.
